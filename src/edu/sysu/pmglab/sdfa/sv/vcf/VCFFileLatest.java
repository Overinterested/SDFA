...
public class VCFFileLatest {
    ...
    public VCFFileLatest parse() throws IOException {
        if (parsed) {
            return this;
        }
    ...
    public VCFFileLatest setFileID(int fileID) {
        this.fileID = fileID;
        return this;
    }
    ...
    public VCFFileLatest setFilePath(File filePath) {
        this.filePath = filePath;
    ...
    public VCFFileLatest setFilter(SVFilterManager filter) {
        this.filter = filter;
        return this;
    }

    public VCFFileLatest setSDFEncode(SDFEncode encode) {
    ...
    public VCFFileLatest setWriter(CCFWriter writer) {
        this.writer = writer;
        return this;
    }
    ...
    public VCFFileLatest setChrIndexBlock(IntArray chrIndexBlock) {
