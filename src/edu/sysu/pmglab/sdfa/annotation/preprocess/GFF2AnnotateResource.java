...
/**
 * @author Wenjie Peng
 * @create 2024-04-08 05:27
 * @description
 */
public class GFF2AnnotateResource {
    String resource;
    String version;
    final File gtfFile;
    ...
    public GFF2AnnotateResource(Object gtfPath, Object output) {
    ...
    public GFF2AnnotateResource setResource(String resource) {
        this.resource = resource;
        return this;
    }

    public GFF2AnnotateResource setVersion(String version) {
